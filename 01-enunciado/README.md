# 01 - Enunciado Original do Case

Esta pasta contém o enunciado original do case recebido da Méliuz, mantido aqui para referência durante toda a análise.
...
### Sistema de trabalho com IA

1. Como parte da entrega, queremos avaliar seu nível de maturidade/conhecimento no uso de ferramentas de IA: como você organiza um agente com instruções, validações, critérios de qualidade, reaproveitamento e revisão dos resultados.
2. As entregas 1 e 2 devem ser feitas com base nessa organização, ou seja, não queremos apenas a resposta final, mas também o agente que você usou para chegar nas respostas.
...
4. **Processo, IA e escalabilidade**
   ...
   - Como seu agente poderia ser reutilizado para analisar outros testes de forma recorrente.
...
2. Construa a PRD dessa melhoria, considerando o contexto do produto e os trade-offs envolvidos.
...
- **Formato de entrega:** A entrega deve ser feita em um repositório GitHub que permita revisar a estrutura da solução, a execução da análise, os outputs gerados, as validações realizadas e a proposta de produto.
- **Ferramentas:** use as ferramentas/LLMs que preferir. Além da resposta final, queremos avaliar como você estrutura e utiliza IA para resolver este case de forma executável, auditável, escalável e com menor risco de erro.
...
| Processo, IA e escalabilidade | Estrutura do repositório, execução ponta a ponta, reprodutibilidade, validação dos resultados e uso avançado de IA | Capacidade de transformar análise e decisão de produto em fluxos/agentes reutilizáveis com o uso avançado de IA |
